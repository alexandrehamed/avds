...
<section id="about">
    <div class="container">
        <div class="row">
            <div>
                <div class="col-5 mx-auto" id="about_texte">
            ...
            <div class="col-12">
                <div id="container_icone">
                    <div class="row center">
                        <div class="col-2 offset-md-2"><img
                                    src="<?php echo get_template_directory_uri(); ?>/images/icone1.png"
                                    class="img-fluid" alt=""><br>
                            <p>Sécurité</p></div>
                        <div class="col-2 offset-md-1"><img
                                    src="<?php echo get_template_directory_uri(); ?>/images/icone2.png"
                                    class="img-fluid" alt=""><br>
                            <p>Professionnalisme</p></div>
                        <div class="col-2 offset-md-1"><img
                                    src="<?php echo get_template_directory_uri(); ?>/images/icone3.png"
                                    class="img-fluid" alt=""><br>
                            <p>Qualité</p></div>
                    </div>
                </div>
